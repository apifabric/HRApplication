...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.TrainingClass, method_decorators= method_decorators)
    api.expose_object(database.models.SkillMatrix, method_decorators= method_decorators)
    return api
