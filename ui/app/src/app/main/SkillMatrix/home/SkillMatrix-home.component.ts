...
@Component({
  selector: 'SkillMatrix-home',
  templateUrl: './SkillMatrix-home.component.html',
  styleUrls: ['./SkillMatrix-home.component.scss']
})
export class SkillMatrixHomeComponent implements AfterViewInit {
