...
@Component({
  selector: 'TrainingClass-home',
  templateUrl: './TrainingClass-home.component.html',
  styleUrls: ['./TrainingClass-home.component.scss']
})
export class TrainingClassHomeComponent implements AfterViewInit {
